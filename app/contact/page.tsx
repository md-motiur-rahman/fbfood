  ...
  return (
    <div className="min-h-screen bg-white text-zinc-900">
      ...
      <main className="mx-auto max-w-3xl px-4 sm:px-6 py-8">
        ...
        <p className="mt-2 text-sm text-zinc-600">Reach our wholesale team. We respond within 24 hours.</p>
        <div className="mt-6 grid gap-4">
          ...
          <div className="text-sm text-zinc-600">Mon–Fri, 9am–6pm</div>
        </div>
        <form className="mt-8 grid gap-4">
          ...
          <button className="inline-flex h-11 items-center justify-center rounded-full bg-amber-500 px-6 text-sm font-semibold text-zinc-900 shadow hover:bg-amber-400 w-fit">Request Quote</button>
        </form>
      </main>
    </div>
  );
