  ...
  return (
    <div className="min-h-screen bg-white text-slate-900">
      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 py-8">
        ...
        <p className="mt-2 text-sm text-slate-600">Explore all our brands. Pricing confirmed based on order quantity.</p>
        <div className="mt-5 grid grid-cols-2 gap-3 sm:grid-cols-3 md:grid-cols-4 md:gap-4">
          ...
          {brands.length === 0 && (
            <div className="col-span-full text-sm text-slate-600">No brands available.</div>
          )}
        </div>
      </main>
    </div>
