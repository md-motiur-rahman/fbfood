...
export default function Navbar() {
  ...
  return (
    <header className={`sticky top-0 z-50 ${scrolled || open ? "shadow-sm" : ""}`}>
      <div className={`border-b border-black/5 bg-white/90 backdrop-blur transition-colors`}>
        <div className="mx-auto max-w-7xl px-4 sm:px-6 h-14 flex items-center justify-between">
                ...
                <a
                  ...
                  className={`inline-flex items-center px-3 py-2 text-sm font-medium border-b-2 ${
                    active
                      ...
                      : "text-zinc-700 border-transparent hover:text-zinc-900 hover:border-amber-500"
                  }`}
          ...
          <div className="hidden md:flex items-center gap-3">
            <a href="/contact" className="inline-flex h-9 items-center rounded-full border border-black/10 px-4 text-sm font-medium hover:bg-zinc-50">
              Get a Quote
            </a>
      ...
      {/* Mobile dropdown */}
      <div
        className={`md:hidden absolute left-0 right-0 z-50 origin-top border-b border-black/5 bg-white transition-all ${
      ...
      >
        <nav className="mx-auto max-w-7xl px-4 sm:px-6 py-2 grid">
            ...
            return (
              <a
                ...
                className={`py-3 px-2 text-sm font-medium rounded ${
                  active ? "bg-amber-50 text-zinc-900" : "text-zinc-800 hover:bg-zinc-50"
                }`}
                aria-current={active ? "page" : undefined}
              >
                {l.label}
          ...
          <div className="py-2 flex items-center gap-2">
            <a href="/contact" onClick={() => setOpen(false)} className="inline-flex h-10 flex-1 items-center justify-center rounded-full border border-black/10 px-4 text-sm font-medium hover:bg-zinc-50">
              Get a Quote
            </a>
